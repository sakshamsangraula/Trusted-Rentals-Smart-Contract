...
// use arrow function to not worry about binding this
  ...
  return (
    <div >
      <h2 >Car Contract</h2>
      <p>This contract is managed by {this.state.owner}.
      After sigining this contract you will temporarily become the owner of the contract
      and after the contract expires {this.state.owner} will remain as the owner of the car
      </p>
